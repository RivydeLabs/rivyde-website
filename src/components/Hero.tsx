        ...
        >
          <Box>
            <Typography
              ...
              sx={{
                fontSize: {
                  xs: "clamp(25px, 7.4vw, 34px)",
                  sm: "clamp(30px, 5.8vw, 40px)",
                  md: "clamp(30px, 3.35vw, 42px)",
                },
            ...
            >
              ...
              <br />
              Software{" "}
              <Box component="span" sx={{ color: palette.cyan }}>
                Solutions
              </Box>
              <br />
          ...
          >
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  bgcolor: "#7f8e9d",
                  boxShadow: "0 10px 26px rgba(145, 160, 175, 0.28)",
            ...
            <Button
              ...
              sx={{
                ...
                "&:hover": {
                  ...
                  boxShadow: "0 0 22px rgba(85, 242, 245, 0.24)",
                },
              }}
            >
              Services
