    ...
    >
      ...
      <Container maxWidth="lg">
        ...
        >
          ...
          >
            Rivyde is a software studio focused on building modern web
            applications, digital products, and real-world software solutions
          </Typography>
          <Typography
            sx={{
              maxWidth: 980,
          ...
          >
            Alongside client work, we are also building our first SaaS product
            and experimenting with new ideas through our internal lab
          </Typography>
        </Stack>
      </Container>
      <Box
