...
import { fadeUp, waveDrift, waveScan } from "../animations";
          ...
          {services.map((service, index) => (
            <Box
              ...
              sx={{
                ...
                boxShadow:
                  "0 0 16px rgba(129, 148, 168, 0.28), inset 0 0 18px rgba(129, 148, 168, 0.14)",
                ...
                "&:hover": {
                  ...
                  boxShadow:
                    "0 0 34px rgba(85, 242, 245, 0.32), inset 0 0 22px rgba(129, 148, 168, 0.18)",
                },
                "@media (prefers-reduced-motion: reduce)": {
                  animation: "none",
                  transition: "none",
      ...
      >
        ...
        <Box
          sx={{
            ...
            inset: "18% -8% 0",
            background:
              "linear-gradient(90deg, transparent 12%, rgba(85, 242, 245, 0.18), transparent 88%)",
            mixBlendMode: "screen",
